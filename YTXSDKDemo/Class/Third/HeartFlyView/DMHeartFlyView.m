...
-(void)animateInView:(UIView *)view{
    ...
    //Bloom
    [UIView animateWithDuration:0.2 delay:0.0 usingSpringWithDamping:0.4 initialSpringVelocity:0.5 options:UIViewAnimationOptionCurveEaseOut animations:^{
    ...
    if (controlPoint1.y<[UIScreen mainScreen].bounds.size.height/2.0f) {
        controlPoint1.y = [UIScreen mainScreen].bounds.size.height/2.0f;
    }

    if (controlPoint2.y<[UIScreen mainScreen].bounds.size.height/2.0f) {
        controlPoint2.y = [UIScreen mainScreen].bounds.size.height/2.0f;
    }
