...
//    [self regularLinkRanges:attrStringM]; //使用正则表达式检查所有链接的范围
    [self ec_regularLinkRanges:attrStringM];
...
- (void)ec_regularLinkRanges:(NSMutableAttributedString *)attrStringM {
    ...
    NSArray *results = [dataDetector matchesInString:attrStringM.string options:0 range:regularRange];
