...
#define voiceWaveDisappearDuration 1
...
//    self.backgroundColor = [[UIColor blueColor] colorWithAlphaComponent:0.3];
    ...
    CGFloat firstLineWidth = 2 / [UIScreen mainScreen].scale;
    ...
    CGFloat secondLineWidth = 2 / [UIScreen mainScreen].scale;
...
- (CAShapeLayer *)generateShapeLayerWithLineWidth:(CGFloat)lineWidth
{
    ...
    waveline.strokeColor = [UIColor colorWithHex:0x7fd3f7].CGColor;
...
- (UIImageView *)firstLine
{
    if (!_firstLine) {
        ...
        _firstLine.backgroundColor = [UIColor colorWithHex:0x7fd3f7];
...
- (UIImageView *)secondLine
{
    if (!_secondLine) {
        ...
        _secondLine.backgroundColor = [UIColor colorWithHex:0x7fd3f7];
...
- (CAShapeLayer *)fillShapeLyer
{
    if (!_fillShapeLyer) {
        ...
        _fillShapeLyer.fillColor = [UIColor colorWithHex:0x7fd3f7].CGColor;
        _fillShapeLyer.fillRule = @"even-odd";
        _fillShapeLyer.lineWidth = 1;
